        ...
        <div className="text-center">
          ...
          <form onSubmit={handleSearch} className="max-w-4xl mx-auto mb-12">
            <div className="bg-white rounded-2xl shadow-xl p-2 flex flex-col lg:flex-row gap-2 border border-gray-100">
              ...
              <button
                type="submit"
                className="bg-green-600 hover:bg-primary-700 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-200 flex items-center justify-center group shadow-lg hover:shadow-xl"
              >
                <span>Search</span>
